...
public class ThreadSafeBankAccount2 {
    ...
    public void withdraw(double amount){
        ...
        while (balance <= 0) {
        	try {
        		System.out.println(Thread.currentThread().getName() + "\t Balance below limit - Deposit Money");
    ...
    public void deposit(double amt){
        ...
        while (balance >= 300) {
        	try {
        		System.out.println(Thread.currentThread().getName() + "\t Balance exceeded limit : Withdraw Money");
